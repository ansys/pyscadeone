...
From the :py:class:`GeneratedCode` object, methods are provided to navigate in the model as it is defined in the mapping file
in order to get the corresponding generated code artifacts.

The next sections describe:

- the :ref:`main class<ref_gc_main_class>` for generated code :py:class:`GeneratedCode`,
- the :ref:`classes<ref_gc_model_classes>` related to model elements,
- the :ref:`classes<ref_gc_code_classes>` related to generated code.
