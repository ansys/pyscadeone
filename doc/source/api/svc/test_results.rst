...
Test Results
============
PyScadeOne services allows to load the test results file in Python objects. :py:class:`TestResultsParser` allows
uses the :py:meth:`load` method to load the test results file and return a :py:class:`TestResults` object.
