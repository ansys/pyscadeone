...
def main():
    ...
    subparser = parser.add_subparsers(
        title="Sub-commands", help="use: command --help for help", dest="subparser_command"
    )

    # Script mode command
    script_parser = subparser.add_parser("script", help="script command")
    script_parser.add_argument("--file", help="load & run script file", dest="script")
    script_parser.add_argument("--module", help="load & run module")
    ...
    # FMU export command
    fmu_parser = subparser.add_parser("fmu", help="FMU export")
    ...
    # Simulation data
    sd_parser = subparser.add_parser("simdata", help="simdata command")
